...
var flow_path = 'C:/instagram_like/Tags/tag';
...
casper.then(function() {{techo('py import confige\nprint(confige.model)');
py_result = ''; if (!py_step('py import confige\nprint(confige.model)'))
...
casper.then(function() {if ((model=="1"))
{ // start of code block
...
if (download_path.indexOf(':')>0) download_path = download_path.replace(/\//g,'\\').replace(/\\/g,'\\');
chrome_step('Page.setDownloadBehavior',{behavior: 'allow', downloadPath: download_path});
chrome_step('Page.navigate',{url: 'https://www.instagram.com/'}); sleep(1000);
techo('https://www.instagram.com/' + ' - ' + chrome.getTitle());});

//读取用户名
casper.then(function() {{techo('py import tagCsv\nimport confige\nprint(confige.username)');
py_result = ''; if (!py_step('py import tagCsv\nimport confige\nprint(confige.username)'))
this.echo('ERROR - cannot execute Python command(s)').exit(); this.wait(0);
py_result = fetch_py_text(); clear_py_text();
try {py_json = JSON.parse(py_result);} catch(e) {py_json = JSON.parse('null');}}});
...
//读取密码
casper.then(function() {{techo('py print(confige.password)');
py_result = ''; if (!py_step('py print(confige.password)'))
this.echo('ERROR - cannot execute Python command(s)').exit(); this.wait(0);
py_result = fetch_py_text(); clear_py_text();
try {py_json = JSON.parse(py_result);} catch(e) {py_json = JSON.parse('null');}}});
...
casper.then(function() {if ((present('//*[@id="react-root"]/section/nav/div[2]/div/div/div[3]/div/div[5]/span/img')))
{ // start of code block

casper.then(function() {{techo('click //*[@id="react-root"]/section/nav/div[2]/div/div/div[3]/div/div[5]/span/img');
casper.waitFor(function check() {return check_tx('//*[@id="react-root"]/section/nav/div[2]/div/div/div[3]/div/div[5]/span/img');},
function then() {chrome.click(tx('//*[@id="react-root"]/section/nav/div[2]/div/div/div[3]/div/div[5]/span/img'));},
function timeout() {this.echo('ERROR - cannot find //*[@id="react-root"]/section/nav/div[2]/div/div/div[3]/div/div[5]/span/img').exit();});}});

casper.then(function() {{techo('click //*[@id="react-root"]/section/nav/div[2]/div/div/div[3]/div/div[5]/div[2]/div/div[2]/div[2]/div/div');
casper.waitFor(function check() {return check_tx('//*[@id="react-root"]/section/nav/div[2]/div/div/div[3]/div/div[5]/div[2]/div/div[2]/div[2]/div/div');},
function then() {chrome.click(tx('//*[@id="react-root"]/section/nav/div[2]/div/div/div[3]/div/div[5]/div[2]/div/div[2]/div[2]/div/div'));},
function timeout() {this.echo('ERROR - cannot find //*[@id="react-root"]/section/nav/div[2]/div/div/div[3]/div/div[5]/div[2]/div/div[2]/div[2]/div/div').exit();});}});

} // end of code block
});

casper.then(function() {{techo('type //*[@id="loginForm"]/div/div[1]/div/label/input as '+username+'');
casper.waitFor(function check() {return check_tx('//*[@id="loginForm"]/div/div[1]/div/label/input');},
function then() {chrome.sendKeys(tx('//*[@id="loginForm"]/div/div[1]/div/label/input'),''+username+'');},
function timeout() {this.echo('ERROR - cannot find //*[@id="loginForm"]/div/div[1]/div/label/input').exit();});}});

casper.then(function() {{techo('type //*[@id="loginForm"]/div/div[2]/div/label/input as '+pass_word+'');
casper.waitFor(function check() {return check_tx('//*[@id="loginForm"]/div/div[2]/div/label/input');},
function then() {chrome.sendKeys(tx('//*[@id="loginForm"]/div/div[2]/div/label/input'),''+pass_word+'');},
function timeout() {this.echo('ERROR - cannot find //*[@id="loginForm"]/div/div[2]/div/label/input').exit();});}});

casper.then(function() {{techo('click //*[@id="loginForm"]/div/div[3]');
casper.waitFor(function check() {return check_tx('//*[@id="loginForm"]/div/div[3]');},
function then() {chrome.click(tx('//*[@id="loginForm"]/div/div[3]'));},
function timeout() {this.echo('ERROR - cannot find //*[@id="loginForm"]/div/div[3]').exit();});}});

casper.then(function() {techo('wait 3');});
casper.then(function() {casper.wait(3000, function() {});});

//判断是是否有弹窗
casper.then(function() {if ((present('//*[@id="react-root"]/section/main/div/div/div/div/button')))
{ // start of code block

{

casper.then(function() {{techo('click //*[@id="react-root"]/section/main/div/div/div/div/button');
casper.waitFor(function check() {return check_tx('//*[@id="react-root"]/section/main/div/div/div/div/button');},
function then() {chrome.click(tx('//*[@id="react-root"]/section/main/div/div/div/div/button'));},
function timeout() {this.echo('ERROR - cannot find //*[@id="react-root"]/section/main/div/div/div/div/button').exit();});}});
...
casper.then(function() {{techo('click //*[@id="react-root"]/section/nav/div[2]/div/div/div[2]/div/div');
casper.waitFor(function check() {return check_tx('//*[@id="react-root"]/section/nav/div[2]/div/div/div[2]/div/div');},
function then() {chrome.click(tx('//*[@id="react-root"]/section/nav/div[2]/div/div/div[2]/div/div'));},
function timeout() {this.echo('ERROR - cannot find //*[@id="react-root"]/section/nav/div[2]/div/div/div[2]/div/div').exit();});}});

//循环读取关键词
casper.then(function() {{techo('py print(len(confige.spot))');
py_result = ''; if (!py_step('py print(len(confige.spot))'))
this.echo('ERROR - cannot execute Python command(s)').exit(); this.wait(0);
py_result = fetch_py_text(); clear_py_text();
try {py_json = JSON.parse(py_result);} catch(e) {py_json = JSON.parse('null');}}});
...
//读取当前关键词位置
casper.then(function() {{techo('py order = int(confige.spot_order)');
py_result = ''; if (!py_step('py order = int(confige.spot_order)'))
this.echo('ERROR - cannot execute Python command(s)').exit(); this.wait(0);
py_result = fetch_py_text(); clear_py_text();
try {py_json = JSON.parse(py_result);} catch(e) {py_json = JSON.parse('null');}}});
...
casper.then(function() {for (n=1; n<=key_numbers; n++)
{casper.then(function() {for_loop_signal = '[CONTINUE_SIGNAL][n]';});
(function (n) { // start of IIFE pattern
{ // start of code block

casper.then(function() {{techo('py if order>=len(confige.spot):\n    order=0\nprint(confige.spot[order])');
py_result = ''; if (!py_step('py if order>=len(confige.spot):\n    order=0\nprint(confige.spot[order])'))
this.echo('ERROR - cannot execute Python command(s)').exit(); this.wait(0);
py_result = fetch_py_text(); clear_py_text();
try {py_json = JSON.parse(py_result);} catch(e) {py_json = JSON.parse('null');}}});
...
//输入关键词
casper.then(function() {{techo('type //*[@id="react-root"]/section/nav/div[2]/div/div/div[2]/input as [clear]'+keyword+'[enter]');
casper.waitFor(function check() {return check_tx('//*[@id="react-root"]/section/nav/div[2]/div/div/div[2]/input');},
function then() {chrome.sendKeys(tx('//*[@id="react-root"]/section/nav/div[2]/div/div/div[2]/input'),'',{reset: true});
chrome.sendKeys(tx('//*[@id="react-root"]/section/nav/div[2]/div/div/div[2]/input'),''+keyword+'',{keepFocus: true});
chrome.sendKeys(tx('//*[@id="react-root"]/section/nav/div[2]/div/div/div[2]/input'),casper.page.event.key.Enter,{keepFocus: true});
chrome.sendKeys(tx('//*[@id="react-root"]/section/nav/div[2]/div/div/div[2]/input'),'',{keepFocus: true});},
function timeout() {this.echo('ERROR - cannot find //*[@id="react-root"]/section/nav/div[2]/div/div/div[2]/input').exit();});}});

casper.then(function() {techo('wait 3');});
casper.then(function() {casper.wait(3000, function() {});});

casper.then(function() {{techo('click //*[@id="react-root"]/section/nav/div[2]/div/div/div[2]/div[3]/div[2]/div/a[1]');
casper.waitFor(function check() {return check_tx('//*[@id="react-root"]/section/nav/div[2]/div/div/div[2]/div[3]/div[2]/div/a[1]');},
function then() {chrome.click(tx('//*[@id="react-root"]/section/nav/div[2]/div/div/div[2]/div[3]/div[2]/div/a[1]'));},
function timeout() {this.echo('ERROR - cannot find //*[@id="react-root"]/section/nav/div[2]/div/div/div[2]/div[3]/div[2]/div/a[1]').exit();});}});
...
casper.then(function() {for (row1=1; row1<=row1_numbers; row1++)
{casper.then(function() {for_loop_signal = '[CONTINUE_SIGNAL][row1]';});
(function (row1) { // start of IIFE pattern
{ // start of code block

casper.then(function() {for (column1=1; column1<=column1_numbers; column1++)
{casper.then(function() {for_loop_signal = '[CONTINUE_SIGNAL][column1]';});
(function (column1) { // start of IIFE pattern
{ // start of code block

//逐个点开热点帖子
casper.then(function() {{techo('click  //*[@id="react-root"]/section/main/article/div[2]/div/div['+row1+']/div['+column1+']/a/div');
casper.waitFor(function check() {return check_tx('//*[@id="react-root"]/section/main/article/div[2]/div/div['+row1+']/div['+column1+']/a/div');},
function then() {chrome.click(tx('//*[@id="react-root"]/section/main/article/div[2]/div/div['+row1+']/div['+column1+']/a/div'));},
function timeout() {this.echo('ERROR - cannot find //*[@id="react-root"]/section/main/article/div[2]/div/div['+row1+']/div['+column1+']/a/div').exit();});}});

casper.then(function() {techo('wait 3');});
casper.then(function() {casper.wait(3000, function() {});});

//点赞
casper.then(function() {dom_result = ''; dom_result = chrome.evaluate(function(dom_json) {return document.querySelector('[aria-label="Like"]').getAttribute("aria-label")}, dom_json);});
...
casper.then(function() {if ((label=="Like"))
{ // start of code block

casper.then(function() {{techo('click /html/body/div[4]/div[2]/div/article/div[3]/section[1]/span[1]/button');
casper.waitFor(function check() {return check_tx('/html/body/div[4]/div[2]/div/article/div[3]/section[1]/span[1]/button');},
function then() {chrome.click(tx('/html/body/div[4]/div[2]/div/article/div[3]/section[1]/span[1]/button'));},
function timeout() {this.echo('ERROR - cannot find /html/body/div[4]/div[2]/div/article/div[3]/section[1]/span[1]/button').exit();});}});
...
//记录关键词，发布者ID，时间
casper.then(function() {{techo('read /html/body/div[4]/div[2]/div/article/header/div[2]/div[1]/div[1]/span/a to id');
casper.waitFor(function check() {return check_tx('/html/body/div[4]/div[2]/div/article/header/div[2]/div[1]/div[1]/span/a');},
function then() {id = chrome.fetchText(tx('/html/body/div[4]/div[2]/div/article/header/div[2]/div[1]/div[1]/span/a')).trim();},
function timeout() {this.echo('ERROR - cannot find /html/body/div[4]/div[2]/div/article/header/div[2]/div[1]/div[1]/span/a').exit();});}});

casper.then(function() {this.echo(''+now+'');});

casper.then(function() {this.echo(''+keyword+'');});
...
casper.then(function() {{techo('py import tagCsv\nimport confige\nheaders = [\'keyword\',\'id\',\'now\']\nrow = {\n       \'keyword\':keyword,\n       \'id\':id,\n       \'now\':now\n       }\ntagCsv.entered_spot_writeCsv(headers,row)');
py_result = ''; if (!py_step('py import tagCsv\nimport confige\nheaders = [\'keyword\',\'id\',\'now\']\nrow = {\n       \'keyword\':keyword,\n       \'id\':id,\n       \'now\':now\n       }\ntagCsv.entered_spot_writeCsv(headers,row)'))
this.echo('ERROR - cannot execute Python command(s)').exit(); this.wait(0);
py_result = fetch_py_text(); clear_py_text();
try {py_json = JSON.parse(py_result);} catch(e) {py_json = JSON.parse('null');}}});
...
//点击关注
casper.then(function() {{techo('click /html/body/div[4]/div[2]/div/article/header/div[2]/div[1]/div[2]/button');
casper.waitFor(function check() {return check_tx('/html/body/div[4]/div[2]/div/article/header/div[2]/div[1]/div[2]/button');},
function then() {chrome.click(tx('/html/body/div[4]/div[2]/div/article/header/div[2]/div[1]/div[2]/button'));},
function timeout() {this.echo('ERROR - cannot find /html/body/div[4]/div[2]/div/article/header/div[2]/div[1]/div[2]/button').exit();});}});

casper.then(function() {techo('wait 2');});
casper.then(function() {casper.wait(2000, function() {});});

//判断是否弹出取消关注
casper.then(function() {if ((present('/html/body/div[5]/div/div/div/div[3]/button[2]')))
{ // start of code block

{

casper.then(function() {{techo('click /html/body/div[5]/div/div/div/div[3]/button[2]');
casper.waitFor(function check() {return check_tx('/html/body/div[5]/div/div/div/div[3]/button[2]');},
function then() {chrome.click(tx('/html/body/div[5]/div/div/div/div[3]/button[2]'));},
function timeout() {this.echo('ERROR - cannot find /html/body/div[5]/div/div/div/div[3]/button[2]').exit();});}});
...
casper.then(function() {{techo('click /html/body/div[4]/div[3]/button/div');
casper.waitFor(function check() {return check_tx('/html/body/div[4]/div[3]/button/div');},
function then() {chrome.click(tx('/html/body/div[4]/div[3]/button/div'));},
function timeout() {this.echo('ERROR - cannot find /html/body/div[4]/div[3]/button/div').exit();});}});

casper.then(function() {techo('wait 1');});
casper.then(function() {casper.wait(1000, function() {});});

} // end of code block
})(column1); // end of IIFE pattern, with dummy marker for break step
casper.then(function() {for_loop_signal = '[BREAK_SIGNAL][column1]';});}});

} // end of code block
})(row1); // end of IIFE pattern, with dummy marker for break step
casper.then(function() {for_loop_signal = '[BREAK_SIGNAL][row1]';});}});

casper.then(function() {{techo('py import tagCsv\nimport confige\norder=order+1\nprint(str(order))\nconfige.update_spot_order(str(order))');
py_result = ''; if (!py_step('py import tagCsv\nimport confige\norder=order+1\nprint(str(order))\nconfige.update_spot_order(str(order))'))
this.echo('ERROR - cannot execute Python command(s)').exit(); this.wait(0);
py_result = fetch_py_text(); clear_py_text();
try {py_json = JSON.parse(py_result);} catch(e) {py_json = JSON.parse('null');}}});
...
casper.then(function() {if ((model=="2"))
{ // start of code block
...
//循环读取关键词
casper.then(function() {{techo('py print(len(confige.key_word))');
py_result = ''; if (!py_step('py print(len(confige.key_word))'))
this.echo('ERROR - cannot execute Python command(s)').exit(); this.wait(0);
py_result = fetch_py_text(); clear_py_text();
try {py_json = JSON.parse(py_result);} catch(e) {py_json = JSON.parse('null');}}});
...
//读取当前关键词位置
casper.then(function() {{techo('py order = int(confige.key_order)');
py_result = ''; if (!py_step('py order = int(confige.key_order)'))
this.echo('ERROR - cannot execute Python command(s)').exit(); this.wait(0);
py_result = fetch_py_text(); clear_py_text();
try {py_json = JSON.parse(py_result);} catch(e) {py_json = JSON.parse('null');}}});
...
casper.then(function() {{techo('py if order>=len(confige.key_word):\n    order=0\nprint(confige.key_word[order])');
py_result = ''; if (!py_step('py if order>=len(confige.key_word):\n    order=0\nprint(confige.key_word[order])'))
this.echo('ERROR - cannot execute Python command(s)').exit(); this.wait(0);
py_result = fetch_py_text(); clear_py_text();
try {py_json = JSON.parse(py_result);} catch(e) {py_json = JSON.parse('null');}}});
...
casper.then(function() {if ((model=="3"))
{ // start of code block
...
//循环读取关键词
casper.then(function() {{techo('py print(len(confige.famous_person))');
py_result = ''; if (!py_step('py print(len(confige.famous_person))'))
this.echo('ERROR - cannot execute Python command(s)').exit(); this.wait(0);
py_result = fetch_py_text(); clear_py_text();
try {py_json = JSON.parse(py_result);} catch(e) {py_json = JSON.parse('null');}}});
...
//读取当前关键词位置
casper.then(function() {{techo('py order = int(confige.famous_order)');
py_result = ''; if (!py_step('py order = int(confige.famous_order)'))
this.echo('ERROR - cannot execute Python command(s)').exit(); this.wait(0);
py_result = fetch_py_text(); clear_py_text();
try {py_json = JSON.parse(py_result);} catch(e) {py_json = JSON.parse('null');}}});
...
casper.then(function() {{techo('py if order>=len(confige.famous_person):\n    order=0\nprint(confige.famous_person[order])');
py_result = ''; if (!py_step('py if order>=len(confige.famous_person):\n    order=0\nprint(confige.famous_person[order])'))
this.echo('ERROR - cannot execute Python command(s)').exit(); this.wait(0);
py_result = fetch_py_text(); clear_py_text();
try {py_json = JSON.parse(py_result);} catch(e) {py_json = JSON.parse('null');}}});
...
casper.then(function() {{techo('click //*[@id="react-root"]/section/main/div/header/section/ul/li[2]');
casper.waitFor(function check() {return check_tx('//*[@id="react-root"]/section/main/div/header/section/ul/li[2]');},
function then() {chrome.click(tx('//*[@id="react-root"]/section/main/div/header/section/ul/li[2]'));},
function timeout() {this.echo('ERROR - cannot find //*[@id="react-root"]/section/main/div/header/section/ul/li[2]').exit();});}});
...
casper.then(function() {for (fan=1; fan<=infinity; fan++)
{casper.then(function() {for_loop_signal = '[CONTINUE_SIGNAL][fan]';});
(function (fan) { // start of IIFE pattern
{ // start of code block

casper.then(function() {if ((!present('/html/body/div[4]/div/div/div[2]/ul/div/li['+fan+']/div/div[3]')))
{ // start of code block

casper.then(function() { // start of JS code
casper.bypass(teleport_distance('[BREAK_SIGNAL][fan]')); return;
}); // end of JS code

} // end of code block
});

casper.then(function() {{techo('click /html/body/div[4]/div/div/div[2]/ul/div/li['+fan+']/div/div[3]');
casper.waitFor(function check() {return check_tx('/html/body/div[4]/div/div/div[2]/ul/div/li['+fan+']/div/div[3]');},
function then() {chrome.click(tx('/html/body/div[4]/div/div/div[2]/ul/div/li['+fan+']/div/div[3]'));},
function timeout() {this.echo('ERROR - cannot find /html/body/div[4]/div/div/div[2]/ul/div/li['+fan+']/div/div[3]').exit();});}});

casper.then(function() {techo('wait 2');});
casper.then(function() {casper.wait(2000, function() {});});

casper.then(function() {if ((present('/html/body/div[5]/div/div/div/div[2]/button[2]')))
{ // start of code block

{

casper.then(function() {{techo('click /html/body/div[5]/div/div/div/div[2]/button[2]');
casper.waitFor(function check() {return check_tx('/html/body/div[5]/div/div/div/div[2]/button[2]');},
function then() {chrome.click(tx('/html/body/div[5]/div/div/div/div[2]/button[2]'));},
function timeout() {this.echo('ERROR - cannot find /html/body/div[5]/div/div/div/div[2]/button[2]').exit();});}});
...
})(fan); // end of IIFE pattern, with dummy marker for break step
casper.then(function() {for_loop_signal = '[BREAK_SIGNAL][fan]';});}});
...
casper.then(function() {{techo('click /html/body/div[1]/section/nav/div[2]/div/div/div[3]/div/div[1]/div/a');
casper.waitFor(function check() {return check_tx('/html/body/div[1]/section/nav/div[2]/div/div/div[3]/div/div[1]/div/a');},
function then() {chrome.click(tx('/html/body/div[1]/section/nav/div[2]/div/div/div[3]/div/div[1]/div/a'));},
function timeout() {this.echo('ERROR - cannot find /html/body/div[1]/section/nav/div[2]/div/div/div[3]/div/div[1]/div/a').exit();});}});
